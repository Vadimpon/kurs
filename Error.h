...
{
private:
    std::string Logfile; ///< Путь к файлу с логом ошибок
public:
	Error(){}; ///< Конструктор без параметров
    void setLogname(std::string Logname){Logfile = Logname;} ///<Функция, устанавливающая путь к файлу с логом ошибок
/** 
